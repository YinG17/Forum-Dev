...
export class LoggerService {
  ...
  public handleError(error: any) {
    ...
    console.log(`wordpress error: `, err);
    console.log(`wp error status: `, errStatus);
    console.log(`wp error code: `, errCode);
    console.log(`wp error data: `, errData);
    if (errData) {
      console.log(`wp error data params`, ...errData.params);
    }
    console.log(`wp error message: `, errMsg);
  }
...
//       console.log(error);
//       this.message(
//         `something went wrong!? n\ Error Status: ${errStatus}, Error Code: ${errCode}. check further information in the console`
//       );
//     }
//   }
// }
